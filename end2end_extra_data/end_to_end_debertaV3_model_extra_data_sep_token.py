...
class BertDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        description = f"{item['case_title']} [SEP] {item['ChallengeDescription']} [SEP] {item['aim']} [SEP] {item['req']} [SEP] {item['terminology']}"
        abstrast = f"{item['paper_title']} [SEP] {item['abstract']}"
        label = item["label"]
