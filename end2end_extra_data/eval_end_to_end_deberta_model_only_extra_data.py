...
class BertDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        description = f"title: {item['case_title']}; aim: {item['aim']}; req: {item['req']}; terminology: {item['terminology']}"
        abstrast = f"title: {item['paper_title']};"
...
def load_data():
    return pd.read_csv("./data/test_df_extra_data.csv")
...
def main():
    ...
    models = ["deberta-v3-only-extra-data-e1-e0"]
