...
class EndToEndClassifier(nn.Module):
    def __init__(self, freeze_bert=False):
        ...
        self.bert = DebertaV2Model.from_pretrained(model_name, config=conf)
    ...
    def forward(self, description_input, abstract_input):
        output_1 = self.bert(**description_input)[0]
        output_2 = self.bert(**abstract_input)[0]
...
def load_data():
    return pd.read_csv("./data/df_extra/test_df_extra_data.csv")
...
def main():
    ...
    models = ["deberta-v3-extra-data-e1-e2"]
